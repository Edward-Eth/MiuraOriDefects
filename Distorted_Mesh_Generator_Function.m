function [] = Distorted_Mesh_Generator_Function(method,inputdev,inputtear,inputstiff,repeats)
% A callable generator for distorted Miura Ori Meshes, all necessary
% arguments are defined when the function is called. Will create
% abaqus.inp files, batch files to run these and a matlab script to extract
% desired data results. Tear runs require the communications toolbox to be
% installed.
...
Count_M = 3; % Unit cells in y direction
Count_N = 3; % Unit cells in x direction

%

%% Step Three: Define deviation method

Deviation_Method_Switch = method;
...
%Deviation = 0.1; %Standard deviation of nodes manual define
%Tears = 0.04; %Proportion of folds to be torn
Tears = inputtear; % proportion of folds to be torn function mode
%StiffnessVary = 4; %Standard deviation of stiffness of edges
StiffnessVary = inputstiff; % variation of stiffnesses function mode
...
Repetition = 1; %Logical Switch
Repeat_Count = repeats; %Number of Repeats
