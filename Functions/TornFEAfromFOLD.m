function [] = TornFEAfromFOLD(filename,meshsize,displacement,m,n,Tears,rundocfolder)
%TornFEAfromFOLD Function generates an abaqus input file from a .FOLD file,
%with preset loading conditions and with a proportion of randomly selected
%folds torn. Requires the communications toolbox.
...
FoldStiffnessPerLength = 0.1; % Nmm/rad/mm
